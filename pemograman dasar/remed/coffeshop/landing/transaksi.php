...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $namacus = isset($_POST['nama_customer']) ? $_POST['nama_customer'] : '';
    $tambahan = isset($_POST['tambahan']) ? $_POST['tambahan'] : 0;

    // Menghitung total harga jika tombol Hitung Total Harga ditekan
    if (isset($_POST['hitung_total_harga'])) {
        $totalHarga = ($hargaProduk * $jumlahProduk) + $tambahan;
    ...
    <div class="container mt-5">
        ...
        <form action="" method="post">
            ...
            <div class="col-md-6">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tambahan" id="eskrim" value="50000" <?= ($tambahan == 50000) ? 'checked' : ''; ?>>
                    <label class="form-check-label" for="eskrim">eskrim - Rp 50.000</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tambahan" id="Gula aren" value="5000" <?= ($tambahan == 5000) ? 'checked' : ''; ?>>
                    <label class="form-check-label" for="Gula aren">Gula aren - Rp 5.000</label>
                </div>
            </div>
            <div class="mb-3">
