        ...
        <form method="POST" class="p-4 border rounded bg-light">
            ...
            <div class="mb-3">
                ...
                <select name="tipeKamar" class="form-select">
                    ...
                    <option value="500000" <?php echo (isset($_POST['tipeKamar']) && $_POST['tipeKamar'] == '500000') ? 'selected' : ''; ?>>Standar - Rp500.000</option>
                    <option value="800000" <?php echo (isset($_POST['tipeKamar']) && $_POST['tipeKamar'] == '800000') ? 'selected' : ''; ?>>Deluxe - Rp800.000</option>
                    <option value="1200000" <?php echo (isset($_POST['tipeKamar']) && $_POST['tipeKamar'] == '1200000') ? 'selected' : ''; ?>>Family - Rp1.200.000</option>
                </select>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <?php endif; ?>
                <a type="submit" href="index.php" name="cancel" class="btn btn-secondary w-50">Cancel</a>
            </div>
        </form>
